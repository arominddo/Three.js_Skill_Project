...
export default function printStone() {
  ...
  const stoneBase = textureLoader.load('./Textures/stone.jpg')
  const stoneNormal = textureLoader.load('./Textures/stone.jpg')
  const stoneRoughness = textureLoader.load('./Textures/stone.jpg')
